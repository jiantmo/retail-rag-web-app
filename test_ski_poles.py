...
# Test the category determination for "Ripthal Ski Poles"
product_name = "Ripthal Ski Poles"
product_description = "4-season extended foam grips offer an aggressive hooking point for manipulating bars and buckles. Adjustable vari-width straps provide ergonomic comfort, with or without gloves."

print(f"Testing category determination for '{product_name}':")
